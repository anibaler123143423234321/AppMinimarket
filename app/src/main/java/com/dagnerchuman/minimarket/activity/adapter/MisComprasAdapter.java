...
/*
import com.dagnerchuman.minimarket.activity.ui.compras.DetalleMisComprasActivity;
import com.dagnerchuman.minimarket.communication.AnularPedidoCommunication;
...
public class MisComprasAdapter extends RecyclerView.Adapter<MisComprasAdapter.ViewHolder> {
    ...
    public MisComprasAdapter(List<PedidoConDetallesDTO> pedidos) {
