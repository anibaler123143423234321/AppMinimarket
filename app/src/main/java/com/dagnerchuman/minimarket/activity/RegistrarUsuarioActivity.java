...
import com.dagnerchuman.minimarket.viewmodel.ClienteViewModel;
import com.dagnerchuman.minimarket.viewmodel.DocumentoAlmacenadoViewModel;
import com.dagnerchuman.minimarket.viewmodel.UsuarioViewModel;
...
public class RegistrarUsuarioActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) !=
            ...
            Toast.makeText(this,"leer no concedido",Toast.LENGTH_LONG).show();
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
                    LOCATION_REQUEST_CODE);
        }else{
            Toast.makeText(this,"leer concedido",Toast.LENGTH_LONG).show();
        }
    }

    private void verificarpermisos() {
        int permisoleer = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE);
        //int permisoleerimagenes = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_MEDIA_IMAGES);
        //int permisoescribir = ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE);

        if (permisoleer == PackageManager.PERMISSION_GRANTED){
            Toast.makeText(this,"leer concedido",Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(this,"leer no concedido",Toast.LENGTH_LONG).show();
            requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},LOCATION_REQUEST_CODE);
        }

      /*  if (permisoleerimagenes == PackageManager.PERMISSION_GRANTED){
            Toast.makeText(this,"imagenes concedido",Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(this,"imagenes no concedido",Toast.LENGTH_LONG).show();
            requestPermissions(new String[]{Manifest.permission.READ_MEDIA_IMAGES},LOCATION_REQUEST_CODE);
        }

        if (permisoescribir == PackageManager.PERMISSION_GRANTED){
            Toast.makeText(this,"escribir concedido",Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(this,"escribir no concedido",Toast.LENGTH_LONG).show();
            requestPermissions(new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},LOCATION_REQUEST_CODE);
        }
        */
